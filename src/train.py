#loop de treino, validação e salvamento

#importações necessárias
from src.imports import nn, optim, SummaryWriter, torch, device
from src.dataset import trainloader, testloader
from src.model import SimpleCNN

def train_model():
    #configuração do modelo, critério, otimizador e writer
